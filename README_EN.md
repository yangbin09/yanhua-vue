...
[🎥 Click to Watch Demo Video Online](https://github.com/yangbin09/yanhua-vue/blob/main/assets/demo.mp4)

> Tip: Click the link above to open the GitHub player if the video doesn't play inline.
